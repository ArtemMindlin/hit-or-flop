...
path_input = "data/raw/data_by_popular_inversed_Mar25.parquet"
path_output_txt = "data/processed/unpopus_Mar2025.txt"
path_output_csv = "data/processed/artist_cancion_unpop_Mar2025.parquet"

df = pd.read_parquet(path_input)

# ... (resto del código igual, pero usando path_output_txt y path_output_csv)
...
archivo_csv = path_output_csv

# Verificar si el archivo ya existe
if os.path.exists(archivo_csv):
    df2_existente = pd.read_parquet(archivo_csv)
